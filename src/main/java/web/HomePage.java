...
//	private static WebElement beforePlusIcon;
	...
	// @FindBy(xpath
	// ="(//*[contains(@aria-label,'SmokeShack')]/parent::*/parent::*/parent::*)[2]")//
	// latest change 1.10
...
//	private static WebElement linksUnderInquiries;
	...
	// @FindBy(xpath =
	// "((//*[contains(text(),'ShackBurger')])[1]/following::*[div])[1]/button[2]")
//	@FindBy(xpath = "//*[@aria-label='Add ShackBurger™ to tray']")
//	private WebElement addToBagBtn;
	...
	// @FindBy(xpath =
	// "((//*[contains(text(),'fries')])[1]/following::*[div])[1]/button[2]")
//	@FindBy(xpath = "//*[@aria-label='Add Fries to tray']")
	...
	// @FindBy(xpath =
	// "((//*[contains(text(),'Shack')])[1]/following::*[div])[1]/button[1]")
...
//	@FindBy(css=".slick--field-hero")
	...
	// @FindBy(xpath = "(//a[contains(@aria-label,'Hand-Spun Shakes')])[1]/img")
	// //product was changing every time hence xpath changed
...
//	}
	...
	public void verifyAllModulesInHomePage() {
		...
		// softAssert.assertTrue(new LoginPage(driver).accountIcon.isDisplayed(),
		// "Logged in user name is not displayed");
